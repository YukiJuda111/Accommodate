...
func (c *getCaptchaService) Call(ctx context.Context, in *CallRequest, opts ...client.CallOption) (*CallResponse, error) {
...
func (h *getCaptchaHandler) Call(ctx context.Context, in *CallRequest, out *CallResponse) error {
